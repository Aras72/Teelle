...
![Home روشن با Tagline و Heartbeat](prototypes/homepage-desktop-light-v2.png)

## Home dark v2

![Home تیره تمیز با Tagline و Heartbeat](prototypes/homepage-desktop-dark-v2.png)

Dark surface در v2 صاف است و Texture/Noise نسخه قبلی حذف شده است.

## Essential questions

![سؤال‌های پایه Quick Match](prototypes/quick-match-essential-questions-v2.png)
...
![سؤال‌های تطبیقی Quick Match](prototypes/quick-match-adaptive-questions-v2.png)
...
![مسیر کامل Mobile در تم تیره](prototypes/core-flow-mobile-dark-v2.png)
