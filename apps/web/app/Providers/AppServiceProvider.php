...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        foreach (['content.edit', 'content.review', 'content.publish', 'coverage.view', 'subscription.manage', 'roles.manage', 'users.manage', 'users.view', 'users.edit', 'users.delete'] as $ability) {
