...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        foreach (['content.edit', 'content.review', 'content.publish', 'articles.edit', 'articles.publish', 'coverage.view', 'analytics.view', 'subscription.manage', 'roles.manage', 'users.manage', 'users.view', 'users.edit', 'users.delete', 'site.manage'] as $ability) {
